...
async def ingest_upload(
    ...
    try:
        ...
        print(f"DEBUG: Failed to suggest logical datasets: {e}")
        suggestions = []
    ...
    # Handle explicit logical dataset target
